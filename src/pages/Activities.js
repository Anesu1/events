          ...
          <div className="flex flex-col md:flex-row items-center justify-between space-y-3 md:space-y-0 md:space-x-4 p-4">
            ...
            <div className="w-full md:w-auto flex flex-col md:flex-row space-y-2 md:space-y-0 items-stretch md:items-center justify-end md:space-x-3 flex-shrink-0">
              <Link
                type="button"
                to="/activities/add"
                className="flex items-center justify-center text-white bg-[#1B3562] hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium rounded-lg text-sm px-4 py-2"
              >
                <MdOutlineAdd />
                Add activity
              </Link>
              ...
              <tbody>
                <tr className="border-b ">
                  ...
                  <td className="px-4 py-3 flex items-center justify-end relative gap-5">
                    <Link
                      to="/"
                      className="bg-[#1B3562] text-white text-xs font-medium px-3 py-2 rounded"
                    >
                      Edit
                    </Link>
                    <Link
                      to="/"
                      className="bg-red-500 text-white text-xs font-medium px-2 py-2 rounded"
                    >
                      Delete
                    </Link>
                  </td>
